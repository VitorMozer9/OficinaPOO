...
/**
 * Classe abstrata que implementa o padrão DAO (Data Acess Object) de forma
 * genérica. Permite operações básicas de persistência (adicionar, remover,
 * buscar, editar e carregar) utilizando arquivos JSON como armazenamento.
 *
 * @param <T> Tipo da entidade a ser manipulada (ex: Cliente, Funcionario,
 * Agendamento, etc.)
 */
public abstract class GenericDAO<T> {
    ...
    /**
     * Contrutor da classe GenericDAO. Inicializa o DAO com caminho do JSON e o
     * tipo da lista usada pelo Gson. Carrega os dados do arquivo no momento da
     * criação.
     *
     * @param caminhoDoJson Caminho do arquivo JSON.
     * @param tipoDaLista Tipo da lista (utilizada pelo Gson para
     * desserialização).
     */
     ...
     *
     * @return {@code true} se os dados foram salvos com sucesso, {@code false}
     * caso contrário.
     */
    ...
    /**
     * Carrega os dados do arquivo JSON para a lista em memória. Se o arquivo
     * não existir ou estiver corrompido, a lista será inicializada vazia.
     *
     * @return {@code true} se os dados foram carregados com succeso,
     ...
     * @return {@code true} se os objeto foi removido com sucesso e os dados
     * salvos, {@code false} caso contrário.
     */
